...
(function () {
  ...
  const MODES = [
    ...
    ['Ambient (loop)',[[33,'bokeh'],[34,'water ripples'],[35,'sun glare'],[36,'light streaks'],[38,'aurora'],[39,'godrays'],[40,'clouds'],[41,'caustics'],[42,'embers'],[43,'mist'],[44,'rain'],[45,'snow'],[46,'marble']]],
  ...
  const isAmb = m => [33,34,35,36,38,39,40,41,42,43,44,45,46].includes(m);
  const isTrans = m => m<=32 && m!==31;            // reveal/movement/advanced apply
  const REL = {
    reveal: m=>isTrans(m), movement: m=>isTrans(m), advanced: m=>isTrans(m),
    points: m=>(m<=32&&m!==31)||m===34, dir: m=>[33,35,36,39,40,41,42,43,44,45,46].includes(m), vign: ()=>true,
  };
